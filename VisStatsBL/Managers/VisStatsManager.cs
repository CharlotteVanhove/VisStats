...
namespace VisStatsBL.Managers
{
    ...
    { //manager wordt gebruikt voor de logica van de applicatie
        ...
        { //methode
            ...
            { //gaat door de lijst van vissoorten
        ...
        { //methode
            ...
            { //gaat door de lijst van soorten
                if (!visSoorten.ContainsKey(soort))
                { //als de soort nog niet in de dictionary zit
                    try
                    { //probeert de soort toe te voegen
        ...
        private List<Haven> maakHaven(List<string> havenLijst)
        { //methode
            Dictionary<string, Haven> havens = new(); //maakt een dictionary aan
            foreach (string haven in havenLijst)
            { //gaat door de lijst van havens
                if (!havens.ContainsKey(haven))
                { //als de haven nog niet in de dictionary zit
                    try
                    { //probeert de haven toe te voegen
